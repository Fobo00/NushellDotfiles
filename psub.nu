...
# 		mkfifo $pipe
#
# 		let id = job spawn { # |id| # TODO: Pass ID to closure when nushell/nushell#15220 gets resolved
# 			if $write {
# 				open -r $pipe | do $task # $id
# 			} else {
# 				try {
# 					$in | do $task # $id
# 						| save --append $pipe
# 				} catch {|err|
# 					print -e $err.rendered # TODO: Check for EPIPE
# 				}
# 			}
# 			rm -rf ($pipe | path dirname)
# 		}
